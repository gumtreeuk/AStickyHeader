...
public class PinnedSectionListView extends ListView {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            if (visibleSectionPosition == -1) { // there is no visible sections
                ...
                if (mPinnedShadow != null) {
                    if (getPinnedShadowPosition() == currentSectionPosition) {
    ...
    protected PinnedSectionListAdapter getPinnedAdapter(AbsListView view) {
        Adapter a = view.getAdapter();
        if (a == null) {
            return null;
        }
        if (a instanceof PinnedSectionListAdapter) {
            return (PinnedSectionListAdapter) a;
        }
        return null;
    }
    ...
    private final DataSetObserver mDataSetObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            ...
            if (a instanceof PinnedSectionListAdapter) {
                PinnedSectionListAdapter adapter = (PinnedSectionListAdapter) a;
                if (null != mPinnedShadow && null != adapter
                    && adapter.isItemViewTypePinned( getPinnedShadowPosition() )) {
